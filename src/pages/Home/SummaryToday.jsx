...
const SummaryToday = () => {
  return (
    <>
      <div className="summary-today mt-3 bg-white grid grid-cols-8 px-4 py-8 gap-x-2 rounded-xl ">
        <div className="desc col-span-6 flex flex-col text-hitam my-auto">
          ...
          <div className="location flex font-bold gap-x-1">
            ...
            />
            <div className="loc-name truncate">Rawamangun, Jakara Timur</div>
          </div>
        </div>
        <div className="weather-information col-span-2 flex gap-x-2 items-center text-primary ">
          ...
          <div className="weather-desc flex flex-col">
            <div className="value font-bold text-xl mx-auto">48 &deg;C</div>
