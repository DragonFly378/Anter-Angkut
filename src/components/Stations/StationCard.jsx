    ...
    <>
      ...
      >
        <div className="content grid grid-cols-4 mx-auto gap-x-2">
          <div className="data-stasiun col-span-3 flex flex-row">
            ...
            <div className="status flex flex-col w-4/12">
              ...
              <div
                className={`title mx-auto px-5 rounded-xl font-bold bg-${
          ...
          <div className="lihat-stasiun col-span-1 my-auto text-sm underline underline-offset-2">
